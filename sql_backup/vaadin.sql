...
-- Vytvořeno: Pon 31. čec 2023, 09:45
...
CREATE TABLE `country` (
  `id` int NOT NULL,
  `country_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_czech_ci NOT NULL,
  `version` int NOT NULL,
  `country_code` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_czech_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_czech_ci;
...
INSERT INTO `country` (`id`, `country_name`, `version`, `country_code`) VALUES
(1, 'Afghánistán', 1, 'AFG'),
(2, 'Alandy', 1, 'ALA'),
(3, 'Albánie', 1, 'ALB'),
(4, 'Alžírsko', 1, 'DZA'),
...
CREATE TABLE `guest` (
  ...
  `id_number` varchar(50) COLLATE utf8mb4_czech_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_czech_ci;
...
INSERT INTO `guest` (`id`, `version`, `first_name`, `country_id`, `status_id`, `last_name`, `birth_date`, `date_arrived`, `date_left`, `id_number`) VALUES
(1201, 7, 'Pikachu', 43, 1, 'Filson', '2023-06-01', '2023-06-12', '2023-06-22', '20202020'),
(1454, 2, 'Radek', 43, 1, 'Filsak', '2023-06-12', '2023-08-06', '2023-08-09', '20444222'),
(1609, 3, 'Michal', 43, 1, 'Švarc', '1976-01-10', '2023-07-10', '2023-07-14', '203050865'),
(1610, 3, 'Peter', 198, 1, 'Popelka', '1983-02-14', '2023-07-16', '2023-07-22', '203070456'),
(1651, 0, 'Jana', 198, 1, 'Kollerová', '1989-02-01', '2023-07-27', '2023-08-03', '203060789');
...
INSERT INTO `status` (`id`, `name`, `version`) VALUES
(1, 'Imported lead', 0),
(2, 'Not contacted', 0),
(3, 'Contacted', 0),
(4, 'Customer', 0),
...
('admin', '{bcrypt}$2a$10$qwLpQWt9WZLDvyHvme42l./mWggR2nJli2lUIRQoDlUyvjKpE2XfW', 1),
