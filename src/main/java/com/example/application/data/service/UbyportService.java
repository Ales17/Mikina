...
public class UbyportService {
    ...
    public final List<StatniPrislusnost> list = Arrays.asList(StatniPrislusnost.values());

    public String getUbyport(List<Guest> guests) {
        for (StatniPrislusnost s : list) {
